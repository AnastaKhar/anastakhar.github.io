...
$.getJSON("http://api.openweathermap.org/data/2.5/weather?zip=11235,us&appid=3a986dfc43faea029e9ca6771e8a773c",function(result){
  ...
  $('.element').mouseout(function(){
    $(this).css('background-color','#FFE800');
  });
  });
...
function rotateGridObjects() {
	...
	var now = new Date();
 	...
 	console.log("curent second of the minute: " + second);
